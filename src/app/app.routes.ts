...
export const routes: Routes = [
  ...
  {
    path: AppRoutesEnum.PRIVATE_US,
    loadComponent: () =>
      import("./components/private-us/private-us.component").then(
        (c) => c.PrivateUsComponent
      ),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./components/how-much-save/how-much-save.component").then(
        (c) => c.HowMuchSaveComponent
      ),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./components/blog/view-blog/view-blog.component").then(
        (c) => c.ViewBlogComponent
      ),
  },
  {
    path: "",
